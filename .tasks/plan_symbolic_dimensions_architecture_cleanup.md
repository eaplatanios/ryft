...
- [ ] Resolve all genuinely dual-contract payloads before adding `Operation::Type`. Each concrete
  ...
  - [ ] Parameterize the 32 operation payloads generated by `define_elementwise_operation!` so scalar and array
