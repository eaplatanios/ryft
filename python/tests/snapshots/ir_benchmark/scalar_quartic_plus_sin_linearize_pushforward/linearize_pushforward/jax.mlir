module @jit__unnamed_function attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<f64>) -> (tensor<f64> {jax.result_info = "result"}) {
    ...
    %0 = stablehlo.multiply %arg0, %cst_2 : tensor<f64>
    %cst_3 = stablehlo.constant dense<2.000000e+00> : tensor<f64>
    %1 = stablehlo.multiply %cst_3, %arg0 : tensor<f64>
    %2 = stablehlo.add %0, %1 : tensor<f64>
    %cst_4 = stablehlo.constant dense<2.000000e+00> : tensor<f64>
    %3 = stablehlo.multiply %2, %cst_4 : tensor<f64>
    %4 = stablehlo.multiply %cst, %arg0 : tensor<f64>
    %5 = stablehlo.add %3, %4 : tensor<f64>
    %cst_5 = stablehlo.constant dense<2.000000e+00> : tensor<f64>
    %6 = stablehlo.multiply %5, %cst_5 : tensor<f64>
    %7 = stablehlo.multiply %cst_0, %arg0 : tensor<f64>
    %8 = stablehlo.add %6, %7 : tensor<f64>
    %9 = stablehlo.multiply %arg0, %cst_1 : tensor<f64>
