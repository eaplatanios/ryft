module @jit_vmap_of_grad attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<f64>) -> (tensor<f64> {jax.result_info = "result"}) {
    ...
    %3 = stablehlo.multiply %2, %2 : tensor<2xf64>
    %4 = stablehlo.multiply %3, %2 : tensor<2xf64>
    %5 = stablehlo.cosine %2 : tensor<2xf64>
    %cst = stablehlo.constant dense<1.000000e+00> : tensor<f64>
    %6 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f64>) -> tensor<2xf64>
