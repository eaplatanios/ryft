...
RYFT_XLA_SYS_EXPORT const PJRT_Error *PJRT_Distributed_Runtime_Service_New(
...
RYFT_XLA_SYS_EXPORT void PJRT_Distributed_Runtime_Service_Shutdown(
...
RYFT_XLA_SYS_EXPORT void PJRT_Distributed_Runtime_Service_Destroy(PJRT_Distributed_Runtime_Service_Destroy_Args *args);

typedef void (*PJRT_Distributed_Missed_Heartbeat_Callback)(PJRT_Error *error, void *user_arg);
...
RYFT_XLA_SYS_EXPORT const PJRT_Error *PJRT_Distributed_Runtime_Client_New(
...
RYFT_XLA_SYS_EXPORT PJRT_Error *PJRT_Distributed_Runtime_Client_Connect(
...
RYFT_XLA_SYS_EXPORT PJRT_Error *PJRT_Distributed_Runtime_Client_Blocking_Key_Value_Get(
...
RYFT_XLA_SYS_EXPORT PJRT_Error *PJRT_Distributed_Runtime_Client_Key_Value_Try_Get(
...
RYFT_XLA_SYS_EXPORT PJRT_Error *PJRT_Distributed_Runtime_Client_Key_Value_Set(
...
RYFT_XLA_SYS_EXPORT PJRT_Error *PJRT_Distributed_Runtime_Client_Shutdown(
...
RYFT_XLA_SYS_EXPORT void PJRT_Distributed_Runtime_Client_Destroy(PJRT_Distributed_Runtime_Client_Destroy_Args *args);
