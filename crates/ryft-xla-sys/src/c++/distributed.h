...
const PJRT_Error *PJRT_Distributed_Runtime_Service_New(PJRT_Distributed_Runtime_Service_New_Args *args);
...
void PJRT_Distributed_Runtime_Service_Destroy(PJRT_Distributed_Runtime_Service_Destroy_Args *args);
...
const PJRT_Error *PJRT_Distributed_Runtime_Client_New(PJRT_Distributed_Runtime_Client_New_Args *args);
