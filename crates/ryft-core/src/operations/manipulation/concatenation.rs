        ...
        check_operation_type_inference!(
            ...
            cases = [
                ...
                },
                {
                    input_types = [
                        dynamic_non_axis,
                        ArrayType::new(DataType::F64, Shape::new(vec![Dimension::Static(1), Dimension::Dynamic(crate::types::dimensions::DimensionVariable::new("dynamic", crate::types::dimensions::DimensionBounds::non_negative(Some(3)).unwrap()))])),
                    ],
