...
pub trait ArithmeticDimensionOperation: Operation<DimensionType> {
    ...
    /// Evaluates this operation for two concrete nonnegative extents.
    fn evaluate_extents(&self, left: usize, right: usize) -> Result<usize, DimensionError>;
...
/// Constructs exclusive-upper bounds from inclusive extrema.
pub(crate) fn bounds_from_extrema(lower: usize, maximum: usize) -> Result<DimensionBounds, DimensionError> {
