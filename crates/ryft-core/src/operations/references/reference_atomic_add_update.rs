...
impl<T, U, C> DifferentiableOperation<C> for ReferenceAtomicAddUpdateOperation<T, U>
where
    T: Type,
...
impl<T, U, V, O> TransposableOperation<V, O> for ReferenceAtomicAddUpdateOperation<T, U>
where
    T: Type,
    U: DifferentiableType,
    ReferenceAtomicAddUpdateOperation<T, U>: Operation<Type = U>,
