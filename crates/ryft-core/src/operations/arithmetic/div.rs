...
impl<V: Clone + Value + Div, C> InterpretableOperation<V, C> for DivOperation
where
...
implement_tracer_operator!(@binary std::ops::Div, div, DivOperation, "`div` operation failed");
