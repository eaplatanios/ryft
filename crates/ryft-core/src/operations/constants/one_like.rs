...
mod tests {
    ...
    #[test]
    fn test_one_like() {
        // Verify the operation's identity and rendering.
    ...
    #[test]
    fn test_one_like_type_inference() {
    ...
    #[test]
    fn test_one_like_interpretation() {
        let operation = OneLikeOperation::<ArrayType>::new();
        assert_eq!(
    ...
    #[test]
    fn test_one_like_transposition() {
