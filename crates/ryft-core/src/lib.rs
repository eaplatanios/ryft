...
pub use programs::{
    ...
    ReferenceDischargeableType, ReferenceEffect, ReferenceError, ReferenceFreeze, ReferenceFreezeOperation,
    ReferenceGeneration, ReferenceId, ReferenceIdentity, ReferenceNew, ReferenceNewOperation,
