...
pub use operations::{
    ...
    GatherMode, GatherOperation, GatherOptions, IOTA_OPERATION_NAME, Iota, IotaOperation, LOG_ADD_EXP_OPERATION_NAME,
    ...
    ScatterMode, ScatterOperation, ScatterOptions, ScatterReductionKind, Select, SelectOperation,
