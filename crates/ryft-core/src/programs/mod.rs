...
pub use references::{
    PartialReferenceDischargeResult, REFERENCE_ADD_UPDATE_OPERATION_NAME, REFERENCE_FREEZE_OPERATION_NAME,
    ...
    ReferenceAllocationHandle, ReferenceCompletion, ReferenceCompletionBackend, ReferenceDischarge,
    ReferenceDischargeContext, ReferenceDischargeDriver, ReferenceDischargePayload, ReferenceDischargePolicy,
    ReferenceDischargeReference, ReferenceDischargeRegionDestination, ReferenceDischargeResult, ReferenceDischargeSite,
    ReferenceDischargeValue, ReferenceDischargeableOperation, ReferenceError, ReferenceFreeze,
    ReferenceFreezeOperation, ReferenceGeneration, ReferenceGuard, ReferenceId, ReferenceInput, ReferenceNew,
    ReferenceNewOperation, ReferenceObservation, ReferenceOperationSemantics, ReferenceOutput, ReferenceRead,
    ReferenceReadOperation, ReferenceRegionDischargeBoundary, ReferenceRegionDischargeFork,
    ReferenceRegionStateInsertion, ReferenceRegionSummary, ReferenceReplacementTransaction, ReferenceSource,
    ReferenceStateBinding, ReferenceStateWidening, ReferenceSwap, ReferenceSwapOperation, ReferenceType,
    ReferenceTypeRefinements, ReferenceWrite, ReferenceWriteOperation, ValidatedPendingReplacementTransaction,
