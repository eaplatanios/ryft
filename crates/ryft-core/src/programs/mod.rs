...
pub use references::{
    ...
    ReferenceAliasEdge, ReferenceAliasKind, ReferenceAnalysis, ReferenceAnalysisError, ReferenceCompletion,
    ...
    ValidatedPendingReplacementTransaction, discharge_positional_region_operation, discharge_reference_free_operation,
};
pub use regions::{
