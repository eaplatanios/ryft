...
pub use references::{
    ...
    ReferenceError, ReferenceFreeze, ReferenceFreezeOperation, ReferenceGeneration, ReferenceId, ReferenceIdentity,
    ReferenceNew, ReferenceNewOperation, ReferenceNewOperationProvider, ReferenceObservation, ReferenceRead,
    ReferenceReadOperation, ReferenceRegionInputBinding, ReferenceReplacementPreparation,
    ...
    ReferenceViewValidationError, ReferenceWrite, ReferenceWriteOperation, TakenReferenceGuard,
