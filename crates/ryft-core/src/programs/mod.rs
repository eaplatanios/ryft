...
pub use references::{
    ...
    NewReference, NewReferenceOperation, PartialReferenceDischargeResult, PendingReferenceReservation,
    PendingReferenceReservations, PreparedReferenceValue, REFERENCE_ADD_UPDATE_OPERATION_NAME,
