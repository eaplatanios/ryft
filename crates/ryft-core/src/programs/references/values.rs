...
/// serialized into a program or compilation key, and may be reused after the last handle and every prepared transaction
/// value retaining the original holder allocation are dropped.
