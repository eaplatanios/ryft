    ...
    C::Operation: From<ReferenceIndexOperation> + From<ReferenceDynamicIndexOperation> + From<ReferenceSliceOperation>,
{
    ...
    let mut outputs = match view {
        ...
        ArrayReferenceView::Index { axis, index: ArrayReferenceViewIndex::Symbolic(_) } => {
...
mod tests {
    ...
    use crate::differentiation::{
        DifferentiationContext, DifferentiationDual, DifferentiationTracer, differentiate_at,
    };
    ...
    use crate::operations::{
        REFERENCE_NEW_OPERATION_NAME, REFERENCE_READ_OPERATION_NAME, ReferenceAddUpdate, ReferenceAddUpdateOperation,
    ...
    fn test_array_reference_view_operations() {
        ...
        assert_eq!(index.transform(), ArrayReferenceView::Index { axis: 0, index: ArrayReferenceViewIndex::Static(1) });
