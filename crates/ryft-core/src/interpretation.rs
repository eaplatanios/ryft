...
///
/// This function supports code generated by `#[derive(Operation)]` for the `#[ryft(projected(T))]` and
/// `#[ryft(replicated(T))]` variants. Projected members cannot own composite regions. Mixed and region-carrying
/// operations must keep composite-native interpretation rules.
///
/// # Parameters
///
