...
macro_rules! check_operation_type_inference {
    ...
    (
        ...
        assert_eq!(
            ...
            Err($crate::programs::types::TypeError::Invalid(format!("'{descriptor}' does not support unreduced operands"))),
        );
    }};
    ...
    (
        ...
        let reduced_right = right
            ...
            .unwrap();
        let expected = Err($crate::programs::types::TypeError::Invalid(format!("'{descriptor}' operands must be reduced over the same axes")));
        assert_eq!(
    ...
    (
        ...
        assert_eq!(
            ...
            Err($crate::programs::types::TypeError::Invalid(::core::convert::Into::<::std::string::String>::into($message))),
        );
    }};
