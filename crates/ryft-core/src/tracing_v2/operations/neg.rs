...
impl<V: Traceable<ArrayType> + Neg<Output = V>> InterpretableOp<V> for NegOp {
...
impl<V: Traceable<ArrayType> + Neg<Output = V> + ZeroLike> LinearOp<V> for NegOp {
...
impl<V: Traceable<ArrayType> + Neg<Output = V>, T: TangentSpace<V>> DifferentiableOp<V, T> for NegOp {
...
impl<V: Traceable<ArrayType> + Neg<Output = V>> VectorizableOp<V> for NegOp {
