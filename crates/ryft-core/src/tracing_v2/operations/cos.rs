...
impl<V: Traceable + FloatExt> InterpretableOp<V> for CosOp {
...
impl<V: Traceable + FloatExt, T: TangentSpace<V>> DifferentiableOp<V, T> for CosOp {
...
impl<V: Traceable + FloatExt> VectorizableOp<V> for CosOp {
