...
impl<V: MatrixValue> LinearOp<ArrayType, V> for MatrixTransposeOp {
    fn transpose(
        &self,
...
impl<V: MatrixValue, T: super::matrix::MatrixTangentSpace<V>> DifferentiableOp<ArrayType, V, T> for MatrixTransposeOp {
    fn jvp(
        &self,
