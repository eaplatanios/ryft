...
impl<V: Traceable<ArrayType> + FloatExt> InterpretableOp<V> for SinOp {
...
impl<V: Traceable<ArrayType> + FloatExt, T: TangentSpace<V>> DifferentiableOp<V, T> for SinOp {
...
impl<V: Traceable<ArrayType> + FloatExt> VectorizableOp<V> for SinOp {
