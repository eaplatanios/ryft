...
use crate::operations::control_flow::{ScanOperation, Select, SelectOperation, WhileOperation, WhileTypeSemantics};
...
mod tests {
    ...
    use crate::operations::math::{AddOperation, MulOperation, SUB_OPERATION_NAME, SubOperation};
