...
pub use batching::{
    ...
    VmapDispatchTracerMarker, VmapDispatchValueMarker, Vmappable, align_batch_axis, apply_elementwise_batch,
    apply_with_axes, broadcast_to_batched, lift_elementwise, vmap,
};
