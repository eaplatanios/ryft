...
pub trait DifferentiableDomainExtension: Domain<Type = ArrayType> + DifferentiationContext {
    ...
    where
        ...
        <Self as Domain>::Operation: Clone + ProgramLinearizableOperation<Self>,
        ...
        LinearOperationOf<Self>: ResidualizedOperation<Self>,
    {
        ...
        let (output, pushforward) = self.linearize(function, primals)?.into_parts();
...
where
    ...
    <D as Domain>::Operation: Clone + ProgramLinearizableOperation<D>,
