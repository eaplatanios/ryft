...
mod tests {
    ...
    fn test_intr_bitreverse() {
        ...
        module.body().append_operation({
            let mut block = context.block(&[(i32_type.as_ref(), location)]);
            let arg_0 = block.argument(0).unwrap();
            let op = intr_bitreverse(arg_0, i32_type, location);
            assert_eq!(op.input(), arg_0);
            assert_eq!(op.output_type(), i32_type);
    ...
    #[test]
    fn test_intr_experimental_constrained_sitofp() {
        let context = Context::new();
        context.load_dialect(DialectHandle::llvm());
        let location = context.unknown_location();
        let module = context.module(location);
        ...
        module.body().append_operation({
            ...
            let arg_0 = block.argument(0).unwrap();
            let op =
                intr_experimental_constrained_sitofp(arg_0, f32_type, roundingmode, fp_exception_behavior, location);
            assert_eq!(op.argument_0(), arg_0);
            assert_eq!(op.roundingmode(), roundingmode);
            assert_eq!(op.fp_exception_behavior(), fp_exception_behavior);
            assert_eq!(op.output_type(), f32_type);
    ...
    #[test]
    fn test_intr_experimental_constrained_uitofp() {
        let context = Context::new();
        context.load_dialect(DialectHandle::llvm());
        let location = context.unknown_location();
        let module = context.module(location);
        ...
        module.body().append_operation({
            ...
            let arg_0 = block.argument(0).unwrap();
            let op =
                intr_experimental_constrained_uitofp(arg_0, f32_type, roundingmode, fp_exception_behavior, location);
            assert_eq!(op.argument_0(), arg_0);
            assert_eq!(op.roundingmode(), roundingmode);
            assert_eq!(op.fp_exception_behavior(), fp_exception_behavior);
            assert_eq!(op.output_type(), f32_type);
    ...
    fn test_intr_copysign() {
        ...
        module.body().append_operation({
            ...
            let arg_0 = block.argument(0).unwrap();
            let arg_1 = block.argument(1).unwrap();
            let op = intr_copysign(arg_0, arg_1, f32_type, None, location);
            assert_eq!(op.lhs(), arg_0);
            assert_eq!(op.rhs(), arg_1);
            assert_eq!(op.fastmath_flags().unwrap().to_string(), "#llvm.fastmath<none>");
            assert_eq!(op.output_type(), f32_type);
    ...
    fn test_intr_cttz() {
        ...
        module.body().append_operation({
            let mut block = context.block(&[(i32_type.as_ref(), location)]);
            let arg_0 = block.argument(0).unwrap();
            let op = intr_cttz(arg_0, i32_type, is_zero_poison, location);
            assert_eq!(op.input(), arg_0);
            assert_eq!(op.is_zero_poison(), is_zero_poison);
            assert_eq!(op.output_type(), i32_type);
    ...
    fn test_intr_ctpop() {
        ...
        module.body().append_operation({
            let mut block = context.block(&[(i32_type.as_ref(), location)]);
            let arg_0 = block.argument(0).unwrap();
            let op = intr_ctpop(arg_0, i32_type, location);
            assert_eq!(op.input(), arg_0);
            assert_eq!(op.output_type(), i32_type);
    ...
    fn test_intr_debugtrap() {
        ...
        module.body().append_operation({
            let mut block = context.block_with_no_arguments();
            let op = intr_debugtrap(location);
    ...
    fn test_intr_eh_typeid_for() {
        ...
        module.body().append_operation({
            let mut block = context.block(&[(pointer_type.as_ref(), location)]);
            let arg_0 = block.argument(0).unwrap();
            let op = intr_eh_typeid_for(arg_0, i32_type, location);
    ...
    fn test_intr_minnum() {
        ...
        module.body().append_operation({
            ...
            let arg_0 = block.argument(0).unwrap();
            let arg_1 = block.argument(1).unwrap();
            let op = intr_minnum(arg_0, arg_1, f32_type, None, location);
            assert_eq!(op.lhs(), arg_0);
            assert_eq!(op.rhs(), arg_1);
            assert_eq!(op.fastmath_flags().unwrap().to_string(), "#llvm.fastmath<none>");
            assert_eq!(op.output_type(), f32_type);
    ...
    fn test_intr_nearbyint() {
        ...
        module.body().append_operation({
            let mut block = context.block(&[(f32_type.as_ref(), location)]);
            let arg_0 = block.argument(0).unwrap();
            let op = intr_nearbyint(arg_0, f32_type, None, location);
            assert_eq!(op.input(), arg_0);
            assert_eq!(op.fastmath_flags().unwrap().to_string(), "#llvm.fastmath<none>");
            assert_eq!(op.output_type(), f32_type);
    ...
    fn test_intr_roundeven() {
        ...
        module.body().append_operation({
            let mut block = context.block(&[(f32_type.as_ref(), location)]);
            let arg_0 = block.argument(0).unwrap();
            let op = intr_roundeven(arg_0, f32_type, None, location);
            assert_eq!(op.input(), arg_0);
            assert_eq!(op.fastmath_flags().unwrap().to_string(), "#llvm.fastmath<none>");
            assert_eq!(op.output_type(), f32_type);
    ...
    fn test_intr_ubsantrap() {
        ...
        module.body().append_operation({
            let mut block = context.block_with_no_arguments();
            let op = intr_ubsantrap(failure_kind, location);
